"""
Test xBhp forum scraper v2 (Google search method)
"""
...
from xbhp_scraper_v2 import scrape_xbhp_forums
import json

print("Testing xBhp forum scraper v2 (Google search)...\n")

bike1 = "TVS Apache RTR 160"
bike2 = "Bajaj Pulsar NS160"
