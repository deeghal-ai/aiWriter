...
<bike_comparison>
${bike1Name}:
  + ${relevantInsights.bike1.strengths.join('\n  + ')}
  - ${relevantInsights.bike1.weaknesses.join('\n  - ')}

${bike2Name}:
  + ${relevantInsights.bike2.strengths.join('\n  + ')}
  - ${relevantInsights.bike2.weaknesses.join('\n  - ')}
</bike_comparison>
