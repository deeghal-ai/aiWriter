...
export const SONNET_SYSTEM_PROMPT = `You are an expert motorcycle analyst extracting owner insights from Indian YouTube data.

Your extraction quality is measured by:
1. SPECIFICITY - "Engine refinement at 4000-6000 RPM" not "Good engine"
2. EVIDENCE - Every category needs 3-5 supporting quotes
...
export function buildSonnetExtractionPrompt(
  ...
  return `<context>
Bike: ${bikeName}
Task: Extract comprehensive owner insights from YouTube comments and reviews
Output: Detailed JSON with categories, frequencies, and supporting quotes
</context>
  ...
  "praises": [
    {
      ...
      "quotes": [
        {"text": "exact quote", "author": "username", "source": "YouTube", "likes": N},
        // 3-5 quotes per category
      ]
    }
  ...
  "praises": [
    {
      ...
      "quotes": [
        ...
        {"text": "After 15000kms, the engine is still as smooth as day one", "author": "CommutePro", "source": "YouTube", "likes": 28},
    ...
    },
    {
      ...
      "quotes": [
        ...
        {"text": "Handles potholes way better than Pulsar, suspension soaks everything", "author": "DailyCommuter_HYD", "source": "YouTube", "likes": 41}
      ]
    }
  ],
  "complaints": [
    {
      ...
      "quotes": [
        ...
        {"text": "The service advisor has zero knowledge, kept recommending unnecessary parts", "author": "BikerPune", "source": "YouTube", "likes": 54}
      ]
    }
  ],
  "surprising_insights": [
    "Despite being marketed as a sporty 200cc, 65% of owners in comments primarily use it for daily office commute, not weekend rides",
