...
export function determineOptimalHookStrategy(ctx: CondensedArticleContext): {
  ...
  // Priority 1: Price Paradox (if there's price discussion)
  ...
  // Priority 2: WhatsApp Debate (if verdicts are split)
  ...
  // Priority 3: Unexpected Truth (if surprising insights exist)
  ...
  // Priority 4: Specific Scenario (if distinct personas exist)
  ...
  // Default: Unexpected Truth with best available insight
  return {
    strategy: 'Unexpected Truth',
